...
const RestaurantProvider = ({ children }) => {
  ...
  const loadRestaurantData = useCallback(async (restaurantId, branchId, tableId) => {
    ...
    try {
      ...
      // Check if the restaurant data exists either as a property of branch or already mapped
      const restaurantData = branchData.restaurant || null;
      console.log('Restaurant data from branch:', restaurantData);
